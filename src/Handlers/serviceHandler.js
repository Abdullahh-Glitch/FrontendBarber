...
export const validateForm = (formData, setErrors) => {
    ...
    if (formData.price <= 0) newErrors.price = "Price cannot be zero or negative";
    ...
    if (formData.durationMinutes <= 0) newErrors.durationMinutes = "Duration cannot be zero or negative";
    else if (!isOnlyNumber(formData.durationMinutes.toString())) newErrors.durationMinutes = "Duration must be a valid number";
